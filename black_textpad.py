...
# I have edited some parts - 21st of December, 2020
# Onurcan Köken
...
# ---------------------------------------------------------------
# this part is used to remove title bar and make your own
# def move_window(event):
#     root.geometry('+{0}+{1}'.format(event.x_root, event.y_root))
#
# root.overrideredirect(True) # turns off title bar, geometry
# root.geometry("1200x710+200+200") # set new geometry
#
...
# reference for title bar: https://stackoverflow.com/questions/23836000/can-i-change-the-title-bar-in-tkinter
# ---------------------------------------------------------------
...
# this one is used to remove windows title bar/border
